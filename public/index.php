...
require_once __DIR__ . '/../app/repositories/DelanteroRepository.php';
...
<?php
require __DIR__ . '/../resources/views/components/delantero-form.php';
require __DIR__ . '/../resources/views/components/delete-delantero-form.php';
?>
