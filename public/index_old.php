...
include_once $_SERVER['DOCUMENT_ROOT'] . '/../app/models/Delantero.php';
include_once $_SERVER['DOCUMENT_ROOT'] . '/../app/models/Centrocampista.php';
include_once $_SERVER['DOCUMENT_ROOT'] . '/../app/models/Defensa.php';
include_once $_SERVER['DOCUMENT_ROOT'] . '/../app/models/Entrenador.php';
include_once $_SERVER['DOCUMENT_ROOT'] . '/../app/models/Equipo.php';
